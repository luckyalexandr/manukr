...
class WishlistController extends Controller
{
    ...
    public function __construct($id, $module, WishlistService $service, ProductFetchingRepository $products, $config = [])
    {
    ...
    public function actionAdd($id)
    {
        try {
            ...
            Yii::$app->session->setFlash('success', 'Успешно добавлено в список желаний!');
