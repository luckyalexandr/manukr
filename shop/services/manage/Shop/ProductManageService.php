...
class ProductManageService
{
    ...
    public function create(ProductCreateForm $form): Product
    {
        ...
        $product->setLongitude(
            $form->longitude->min_long,
            $form->longitude->roll_long
        );
    ...
    public function setSlug($product): void
    {
        $product->slug = Inflector::slug($product->name . '-' . $product->code);
        $this->products->save($product);
    }

//    public function import($id, Import $form): void
//    {
...
//    }
    ...
    {
        $product = $this->products->get($id);
        $product->setPrice($form->new, $form->old, $form->min, $form->roll);
        $this->products->save($product);
    }
    ...
    public function changeLongitude($id, LongitudeForm $form): void
    {
        $product = $this->products->get($id);
        $product->setLongitude($form->min_long, $form->roll_long);
        $this->products->save($product);
    }
